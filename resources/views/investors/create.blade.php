<x-app-layout>
    <div class="max-w-4xl mx-auto p-6">
        <h1 class="text-2xl font-bold mb-6">{{ __('Create Investor Profile') }}</h1>

        <form method="POST" action="{{ route('investor-profiles.store') }}" enctype="multipart/form-data" class="space-y-6">
            @csrf
            ...
            <div class="w-full px-6 py-4 bg-white shadow rounded-lg grid gap-6 grid-cols-3">
                <div class="flex flex-col items-center">
                    ...
                    <div class="grid items-center mt-3 h-full">
                        <div class="col-start-1 row-start-1 w-40 h-40 rounded-full object-cover border bg-gray-100"></div>
                ...
                <div class="grid gap-3 col-span-2">
                    ...
                    <div>
                        ...
                        <textarea id="bio" name="bio" rows="4" class="w-full border p-2 rounded">{{ old('bio') }}</textarea>
                    </div>
                </div>
            </div>
